...
### Užsikrėtimai (top 10 be Kinijos)
```{r, echo=FALSE}
df <- data_world %>%
  filter(var=="confirmed")%>%
  spread(date, value)%>%
...
## Mirtys 
### Suminiai rodikliai {.tabset .tabset-fade .tabset-pills}
#### Mirtys (abs.)
#### Mirtys (/pop)
#### Mirtys (top 20)
#### Mirtingumas (top 20)
...
ggplot(df,aes(x=reorder(valstybe,-deathrate), y=deathrate, fill=valstybe))+
  ...
  labs(x="Valstybė", y="Mirtingumas, %", title="Mirtingumas top 10 pasaulio šalių pagal mirčių  skaičių", subtitle="Šaltinis: JHCSSE, skaičiavimai: Corona-Stat.lt" )+
  theme(legend.title=element_blank(),
        legend.position="",
...
### Per paskutinę parą {.tabset .tabset-fade .tabset-pills}
#### Mirtys (abs.)
...
ggplot(df,aes(x=reorder(valstybe,-value), y=value, fill=valstybe))+
  ...
  labs(x="Valstybė", y="Mirčių skaičius", title="Mirčių skaičius top 20 pasaulio šalių", 
       subtitle="Šaltinis: JHCSSE, skaičiavimai: Corona-Stat.lt" )+
  theme(legend.title=element_blank(),
        legend.position="",
        axis.text=element_text(size=8),
...
### Nauji užsikrėtimai  {.tabset .tabset-fade .tabset-pills}
#### Užsikrėtimai (abs.)
