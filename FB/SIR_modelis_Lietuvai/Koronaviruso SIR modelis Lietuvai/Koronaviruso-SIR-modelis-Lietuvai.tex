...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Koronaviruso (COVID-19) SIR modelis Lietuvai},
            colorlinks=false,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{Koronaviruso (COVID-19) SIR modelis Lietuvai}
    \author[Lithuanian-Economy.net]{Justas Mundeikis\corref{1}}
   \ead{justas.mundeikis@lithuanian-economy.net} 
